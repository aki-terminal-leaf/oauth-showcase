...
|----------|----------|-------------|
| 🔵 Google | OpenID Connect | `/auth/callback/google` |
| ⚫ GitHub | OAuth 2.0 | `/auth/callback/github` |
| 🟣 Discord | OAuth 2.0 | `/auth/callback/discord` |
| ⬛ X (Twitter) | OAuth 2.0 + PKCE | `/auth/callback/twitter` |
| 🟢 LINE | OpenID Connect | `/auth/callback/line` |
| 🍎 Apple | OpenID Connect | `/auth/callback/apple` |
| 🔷 Microsoft | OpenID Connect | `/auth/callback/microsoft-entra-id` |
| 🟪 Twitch | OAuth 2.0 | `/auth/callback/twitch` |
...
2. Redirect URI: `http://localhost:3001/auth/callback/microsoft-entra-id`
...
2. OAuth Redirect URL: `http://localhost:3001/auth/callback/twitch`
